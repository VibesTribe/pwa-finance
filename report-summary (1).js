          ...
          <div className="space-y-6">
                ...
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <p className={`text-2xl font-bold ${
                      summaryData.income.total - summaryData.expenses.total >= 0 
                        ? 'text-green-600' 
                        : 'text-red-600'
                    }`}>
                      ${(summaryData.income.total - summaryData.expenses.total).toFixed(2)}
                    </p>
                    <p className="text-xs text-gray-500">
                      {summaryData.totalTransactions} total transactions
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  {summaryData.expenses.count > 0 ? (
                    <div className="h-64">
                      <ExpenseBreakdownChart 
                        data={summaryData.topExpenseCategories.map(item => ({
                          name: item.category,
                          value: item.amount
                        }))}
                      />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-64">
                    <MonthlyBarChart 
                      data={summaryData.dailyTransactions.map(day => ({
                        name: day.date.getDate().toString(),
                        income: day.income,
                        expense: day.expense
                      }))}
                    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  {summaryData.topIncomeCategories.length > 0 ? (
                    <ul className="space-y-2">
                      {summaryData.topIncomeCategories.map(item => (
              ...
              <Card>
                ...
                <CardContent>
                  {summaryData.topExpenseCategories.length > 0 ? (
                    <ul className="space-y-2">
                      {summaryData.topExpenseCategories.map(item => (
                        <li key={item.category} className="flex justify-between items-center">
                          <span className="font-medium">{item.category}</span>
                        ...
                        {periodTransactions
                          ...
                          .map((transaction, index) => (
                            <tr key={index}>
                              ...
                              <td className="px-2 py-2 text-sm">{transaction.description}</td>
                              <td className="px-2 py-2 text-sm">{transaction.category}</td>
